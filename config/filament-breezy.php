...
return [
    /*
    |--------------------------------------------------------------------------
    | My MyProfile filament page
    |--------------------------------------------------------------------------
    | Whether or not to automatically register the My MyProfile page. Set this to false to extend and create your own page.
    */
    "enable_profile_page" => true,
    /*
    | Whether or not to automatically link the My MyProfile page in the user menu of Filament. NOTE: if enable_profile_page => false then this value is ignored and you'll need to register the item in your service provider manually.
    */
    "show_profile_page_in_user_menu" => true,
    /*
    | Whether or not to automatically display the My MyProfile page in the navigation of Filament. NOTE: if enable_profile_page => false then this value is ignored.
    */
    ...
    */
    ...
    /*
    | Set an array that's compatible with the Filament Forms rules() method. Rules for required and confirmed are already set. These rules will apply to the My MyProfile, registration, and password reset forms. To use an instance of the \Illuminate\Validation\Rules\Password::class, see documentation.
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Path to MyProfile page component.
    */
